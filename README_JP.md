...
**単に.mdファイルを作成すればいいのに、なぜBunNoteを使うのか？**

- **ワークフローを維持** - コーディング中にサイドバーからノートにアクセス、アプリの切り替え不要
- **素早いアクセス** - サイドバーパネルでノートがワンクリックで開ける
- **プロジェクトコンテキスト** - コードと一緒にノートを保管、プロジェクト単位またはグローバルVault
- **シンプルな整理** - ドラッグ&ドロップでファイル移動、フォルダ構造、すべてプレーンな.mdファイル
- **ロックインなし** - いつでもどこでも開けるプレーンなMarkdownファイル

単に.mdファイルを作成するだけで満足なら、それで十分です！BunNoteは、同じシンプルさを保ちながら、コーディング中にサイドバーから素早くアクセスしたい開発者向けです。
...
### Markdownエディタ
- WYSIWYG編集機能を備えた本格的なMarkdownエディタ
- コードブロックのシンタックスハイライト
